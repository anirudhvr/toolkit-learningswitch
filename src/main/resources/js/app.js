...
([
 ...
 { 
   ...
   function updateMode() {
     $.ajax({
       url: 'http://127.0.0.1:8080/learningswitch/northbound/learningswitch/function', 
   ...
   $('#refreshNodeList').click(function() {
     // populate table
     $.getJSON('http://127.0.0.1:8080/learningswitch/northbound/learningswitch/flowtable', function(result) {
   ...
   $('#refreshMacTable').click(function() {
     // populate table
     $.getJSON('http://127.0.0.1:8080/learningswitch/northbound/learningswitch/table', function(result) {
   ...
   $('#clearMacTable').click(function() {
     // populate table
     $.ajax({
       url: 'http://127.0.0.1:8080/learningswitch/northbound/learningswitch/table',
       type: 'DELETE',
        });
